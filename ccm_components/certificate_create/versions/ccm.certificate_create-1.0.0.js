...
(() => {
    ...
    const component = {
        ...
        config: {
            ...
            deploy: [
                'ccm.load',
                'https://ccmjs.github.io/rmueller-components/certificate_create/resources/deploy.js'
            ],
            html: [
                'ccm.load',
                'https://ccmjs.github.io/rmueller-components/certificate_create/resources/html.js'
            ],
            css: [
                'ccm.load',
